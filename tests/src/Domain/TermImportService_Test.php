...
final class TermImportService_Test extends DatabaseTestBase
{
    ...
    public function test_language_must_exist() {  // V3-port: DONE feature
        $this->record['language'] = 'UNKNOWN';
        $import = [ $this->record ];
        $this->assertImportThrows($import, 'Unknown language "UNKNOWN"');
    }

    public function test_dup_term_throws() {  // V3-port: DONE feature
    ...
    public function test_bad_status_throws() {  // V3-port: DONE
        $this->record['status'] = '7';
        $import = [ $this->record ];
        $this->assertImportThrows($import, 'Status must be one of 1,2,3,4,5,I,W, or blank');
    }

    public function test_term_required() {  // V3-port: DONE
        $this->record['term'] = '';
        $import = [ $this->record ];
    ...
    public function test_smoke_import_creates_term() {  // V3-port: DONE feature
        $import = [ $this->record ];
    ...
    public function test_smoke_import_two_terms() {  // V3-port: DONE feature
        $import = [
            $this->record,
            [
                'language' => 'Spanish',
    ...
    public function test_existing_terms_not_changed() {  // V3-port: DONE feature
    ...
    public function test_case_insens_term_creation() {  // V3-port: DONE feature
        $t = new Term($this->spanish, 'gato');
        $t->setTranslation('hi there');
        $this->term_repo->save($t, true);
    ...
    public function test_statuses_set_correctly() {  // V3-port: DONE feature
     ...
     * @group importparent
     */
    public function test_term_mapped_to_newly_created_parent() {  // V3-port: DONE feature
    ...
    public function test_same_term_in_different_langs() {  // V3-port: DONE feature
        $import = [
            [ 'language' => 'Spanish',
              'term' => 'gatos',
              'translation' => '',
    ...
    public function test_term_and_parent_imported() {  // V3-port: DONE feature
        $import = [
            [ 'language' => 'Spanish',
              'term' => 'gatos',
              'translation' => '',
    ...
    public function test_smoke_loadImportFile() {  // V3-port: DONE skipping
...
Or a really cool cat.",
     ...
     * @group importfile
     */
    public function test_import_file_with_return_in_translation() {  // V3-port: DONE feature
...
A house cat.",,1,"animal, noun",GA-toh';
     ...
     * @group importfile
     */
    public function test_import_more_stuff() {  // V3-port: DONE
        $content = 'language,term,translation,parent,status,tags,pronunciation
...
2. \"you know\"";
     ...
     * @group importfile
     */
    public function test_fields_can_be_in_different_order() {  // V3-port: DONE feature
...
Spanish,3 trans,third,,W,?,';
     ...
     * @group importcols
     */
    public function test_partial_columns_are_allowd() {  // V3-port: DONE - already covered
        $this->record = [
            'language' => 'Spanish',
            'term' => 'gato',
            'translation' => 'cat'
     ...
     * @group importcols
     */
    public function test_language_and_term_required() {  // V3-port: DONE
        $this->record = [
            'language' => 'Spanish',
            'termx' => 'gato',
        ];
     ...
     * @group importcols
     */
    public function test_only_language_and_term_is_ok() {  // V3-port: DONE feature
        $this->record = [
            'language' => 'Spanish',
            'term' => 'gato',
        ];
     ...
     * @group importcols
     */
    public function test_bad_headings_throws() {  // V3-port: DONE
        $this->record = [
            'language' => 'Spanish',
            'term' => 'gato',
            'badfield' => 'junk'
     ...
     * @group importcols
     */
    public function test_import_file_must_contain_language_and_heading() {  // V3-port: DONE
...
Spanish,term';
     ...
     * @group issue51
     */
    public function test_Mandarin_import_file_with_dups() {  // V3-port: DONE
...
Mandarin,啊,ah,a,HSK4";
     ...
     * @group importcols_1
     */
    public function test_bad_headings_in_file_throws() {  // V3-port: DONE
