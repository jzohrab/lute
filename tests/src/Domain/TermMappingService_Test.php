...
where cw.WoTextLC = '{$tlc}'";
    ...
    public function test_throws_if_parent_or_child_blank_or_null() {  // V3-port: DONE
        foreach (['', ' ', null] as $p) {
     ...
     * @group changetmapi
     */
    public function test_doesnt_create_terms() {  // V3-port: DONE feature
        $sp = $this->spanish;
    ...
    public function test__existing_term_no_parent__existing_parent__mapped() {  // V3-port: DONE feature
        $sp = $this->spanish;
    ...
    public function test__existing_term_no_parent__not_mapped_to_self() {  // V3-port: DONE feature
        $sp = $this->spanish;
        $p = $this->addTerms($sp, ['gato', 'gatos']);
        $mappings = [
    ...
    public function test__existing_term_no_parent__new_parent_created_and_mapped() {  // V3-port: DONE feature
        $sp = $this->spanish;
    ...
    public function test__existing_term_no_parent__new_parent_created_and_mapped_multiple_children() {  // V3-port: DONE feature
        $sp = $this->spanish;
    ...
    public function test__existing_term_HAS_parent__parent_not_changed() {  // V3-port: DONE feature
        $sp = $this->spanish;
    ...
    public function test_stray_term_skipped() {  // V3-port: DONE feature
        $sp = $this->spanish;
    ...
    public function test_new_term_created_and_mapped_to_existing_parent() {  // V3-port: DONE feature
        $sp = $this->spanish;
        $p = $this->addTerms($sp, 'gato');
     ...
     */
    public function test_issue_40_multiple_parents_not_mapped() {  // V3-port: DONE - allow multi parent though
        $sp = $this->spanish;
     ...
     * https://github.com/jzohrab/lute/issues/40
     */
    public function test_issue_40_dup_mapping_ok() {  // V3-port: DONE feature
        $sp = $this->spanish;
     ...
     * https://github.com/jzohrab/lute/issues/40
     */
    public function test_issue_40_case_ignored_for_mapping() {  // V3-port: DONE
        $sp = $this->spanish;
    ...
    public function test_new_term__new_parent_not_created_if_not_otherwise_used() {  // V3-port: DONE - skip redundant
        $sp = $this->spanish;
        $mappings = [
            [ 'parent'=>'gato', 'child'=>'gatos' ]
        ];
    ...
    public function test_new_term__new_parent_created_if_used_by_existing_term() {  // V3-port: DONE
        $sp = $this->spanish;
     ...
     * tests on my machine.
     */
    public function test_child_creates_new_parent_X_and_parent_creates_same_new_child_X() {  // V3-port: DONE
        $sp = $this->spanish;
