...
final class BookStats_Test extends DatabaseTestBase
{
    ...
    public function test_cache_loads_when_prompted()  // V3-port: DONE test unit book stats
    {
    ...
    public function test_stats_smoke_test() {  // V3-port: DONE test unit book stats
        $t = $this->make_text("Hola.", "Hola tengo un gato.", $this->spanish);
        $b = $t->getBook();
     ...
     */
    public function test_stats_calculates_rendered_text() {  // V3-port: DONE test unit book stats
    ...
    public function test_stats_only_update_existing_books_if_specified() {  // V3-port: DONE test unit book stats
        $t = $this->make_text("Hola.", "Hola tengo un gato.", $this->spanish);
        $b = $t->getBook();
        $this->addTerms($this->spanish, [
            "gato", "TENGO"
