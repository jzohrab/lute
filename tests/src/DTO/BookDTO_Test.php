...
final class BookDTO_Test extends TestCase
{
    ...
    public function test_smoke_createBook() {  // V3-port: DONE test book repo
    ...
    public function test_smoke_load_book_replaces_title_and_tags_only() {  // V3-port: DONE skipping
