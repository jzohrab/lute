...
final class SettingsRepository_Test extends DatabaseTestBase
{
    ...
    public function test_save_and_retrieve() {  // V3-port: DONE
    ...
    public function test_missing_key_value_is_null() {  // V3-port: DONE
        $v = $this->settings_repo->getSetting('zzmissing');
        $this->assertTrue($v == null, 'missing setting = null');
    }

    public function test_smoke_last_backup() {  // V3-port: DONE
