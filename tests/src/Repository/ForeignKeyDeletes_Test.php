...
final class ForeignKeyDeletes_Test extends DatabaseTestBase
{
     ...
     * @group fk_booktags
     */
    public function test_booktags_book_model()  // V3-port: DONE - sort of skipped, only necessary for db wipe
    {
     ...
     * @group fk_booktags_1
     */
    public function test_booktags_book_sql()  // V3-port: DONE - sort of skipped, only necessary for db wipe
    {
     ...
     * @group fk_booktags
     */
    public function test_booktags_tag_model()  // V3-port: DONE - sort of skipped, only necessary for db wipe
    {
     ...
     * @group fk_booktags
     */
    public function test_booktags_tag_sql()  // V3-port: DONE - sort of skipped, only necessary for db wipe
    {
     ...
     * @group fk_wordtags
     */
    public function test_wordtags_word_model()  // V3-port: DONE - sort of skipped, only necessary for db wipe
    {
     ...
     * @group fk_wordtags
     */
    public function test_wordtags_word_sql()  // V3-port: DONE - sort of skipped, only necessary for db wipe
    {
     ...
     * @group fk_wordtags
     */
    public function test_wordtags_tag_model()  // V3-port: DONE - sort of skipped, only necessary for db wipe
    {
     ...
     * @group fk_wordtags
     */
    public function test_wordtags_tag_sql()  // V3-port: DONE - sort of skipped, only necessary for db wipe
    {
     ...
     * @group fk_parent
     */
    public function test_delete_word_with_parent_model() {  // V3-port: DONE - sort of skipped, only necessary for db wipe
     ...
     * @group fk_parent
     */
    public function test_delete_word_with_parent_sql() {  // V3-port: DONE - sort of skipped, only necessary for db wipe
        $p = $this->save_parent_with_term();
        $this->exec("delete from words where WoID = {$this->term->getId()}");
     ...
     * @group fk_parent
     */
    public function test_delete_parent_for_word_model() {  // V3-port: DONE - sort of skipped, only necessary for db wipe
        $p = $this->save_parent_with_term();
     ...
     * @group fk_parent
     */
    public function test_delete_parent_for_word_sql() {  // V3-port: DONE - sort of skipped, only necessary for db wipe
        $p = $this->save_parent_with_term();
     ...
     * @group fk_language_1
     */
    public function test_delete_language_model() {  // V3-port: DONE - sort of skipped, only necessary for db wipe
     ...
     * @group fk_language
     */
    public function test_delete_language_sql() {  // V3-port: DONE - sort of skipped, only necessary for db wipe
        $p = $this->save_parent_with_term();
