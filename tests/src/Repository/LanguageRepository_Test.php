...
final class LanguageRepository_Test extends DatabaseTestBase
{
    ...
    public function test_can_delete_language_even_if_terms_and_books_are_defined()  // V3-port: DONE in orm test language.
    {
     ...
     * @group lgfind
     */
    public function test_get_by_name()  // V3-port: DONE test unit models language
    {
        $english = Language::makeEnglish();
        $this->language_repo->save($english, true);
