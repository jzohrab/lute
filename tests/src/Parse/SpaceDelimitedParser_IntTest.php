...
final class SpaceDelimitedParser_IntTest extends DatabaseTestBase
{
     ...
     * @group spaces
     */
    public function test_double_spaces_removed()  // V3-port: DONE render_test_cases.yml
    {
     ...
     * @group current
     */
    public function test_parse_no_words_defined()  // V3-port: DONE render_test_cases.yml
    {
        $t = $this->make_text("Hola.", "Hola tengo un gato.", $this->spanish);
        $this->assert_rendered_text_equals($t, "Hola/ /tengo/ /un/ /gato/.");
    }
     ...
     * @group manytimes
     */
    public function test_text_contains_same_term_many_times()  // V3-port: DONE render_test_cases.yml
    {
    ...
    public function test_text_same_sentence_contains_same_term_many_times()  // V3-port: DONE render_test_cases.yml
    {
        $this->addTerms($this->spanish, ["Un gato"]);
     ...
     * @group apostrophes
     */
    public function test_apostrophes()  // V3-port: DONE render_test_cases.yml
    {
     ...
     * @group lastword
     */
    public function test_last_word_is_a_word()  // V3-port: DONE render_test_cases.yml
    {
